...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 tracking-wide uppercase",
  {
    variants: {
      variant: {
        ...
        PrimaryOutline:"bg-white text-sky-500 hover:bg-slate-200 border-2 border-slate-200 border-b-4 hover:border-slate-300",
        
        Secondry:"bg-green-500 text-primary-foreground hover:bg-green-500/90 border-green-600 border-b-4 active:border-b-0",
        
        SecondryOutline:"bg-white text-green-500 hover:bg-slate-100 ",
        ...
        SidebarOutline:"bg-sky-500/15 text-sky-500 border-2 border-sky-300 hover:bg-sky-500/20 transition-none",
